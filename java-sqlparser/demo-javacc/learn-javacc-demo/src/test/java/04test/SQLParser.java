...
// 语法规则
  final public void sqlQuery() throws ParseException {Token selectToken;
...
{if ("" != null) return columns;}
  ...
  final public Column columnName() throws ParseException {Token t;
    t = jj_consume_token(IDENTIFIER);
{if ("" != null) return new Column(new TokenPosition(t), t.image);}
    throw new Error("Missing return statement in function");
}

  final public Table tableName() throws ParseException {Token t;
    t = jj_consume_token(IDENTIFIER);
{if ("" != null) return new Table(new TokenPosition(t), t.image);}
    throw new Error("Missing return statement in function");
}

  final public Condition whereClause() throws ParseException {Token whereToken;
    Condition condition;
